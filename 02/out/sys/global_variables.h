...
public:
  ...
  Variant tgv_Variant[3];
  #define gvm_begin tgv_Variant[0]
  #define gvm_end tgv_Variant[1]
  #define gvm_elapsed_time tgv_Variant[2]
  bool tgv_bool[2];
  #define run_pm_php$inlude_php tgv_bool[0]
  #define run_pm_php$func_defs_php tgv_bool[1]
