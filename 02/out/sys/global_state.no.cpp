...
static void get_static_global_variables(Array &res) {
  ...
  static_global_variables.set("gv_begin", g->GV(begin));
  static_global_variables.set("gv_end", g->GV(end));
  static_global_variables.set("gv_elapsed_time", g->GV(elapsed_time));
...
static void get_pseudomain_variables(Array &res) {
  ...
  pseudomain_variables.set("run_pm_php$inlude_php", g->run_pm_php$inlude_php);
  pseudomain_variables.set("run_pm_php$func_defs_php", g->run_pm_php$func_defs_php);
