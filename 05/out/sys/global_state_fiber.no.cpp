...
void fiber_marshal_global_state(GlobalVariables *g1, GlobalVariables *g2,
 FiberReferenceMap &refMap) {
  ...
  refMap.marshal(g1->run_pm_php$foo_php, g2->run_pm_php$foo_php);
  refMap.marshal(g1->run_pm_php$bar_php, g2->run_pm_php$bar_php);
...
void fiber_unmarshal_global_state(GlobalVariables *g1, GlobalVariables *g2,
 ...
 const vector<pair<string, char> > &resolver) {
  ...
  char r[15]; memset(r, default_strategy, sizeof(r));
  ...
  if (g2->run_pm_php$foo_php) g1->run_pm_php$foo_php = true;
  if (g2->run_pm_php$bar_php) g1->run_pm_php$bar_php = true;
