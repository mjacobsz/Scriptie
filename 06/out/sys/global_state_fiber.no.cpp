...
class GlobalSymbolMapInitializer {
  public: GlobalSymbolMapInitializer() {
    static const char *names[] = {
      ...
      "gv_an_arr",
      "k_SID",
      "run_pm_php$testinclude_php",
      "run_pm_php$$home$marvin$school$hiphop$util$helper_php",
      0
    };
    int index = 0;
...
void fiber_marshal_global_state(GlobalVariables *g1, GlobalVariables *g2,
 FiberReferenceMap &refMap) {
  ...
  refMap.marshal(g1->GV(an_arr), g2->GV(an_arr));
  refMap.marshal(g1->k_SID, g2->k_SID);
  refMap.marshal(g1->run_pm_php$testinclude_php, g2->run_pm_php$testinclude_php);
  refMap.marshal(g1->run_pm_php$$home$marvin$school$hiphop$util$helper_php, g2->run_pm_php$$home$marvin$school$hiphop$util$helper_php);
...
void fiber_unmarshal_global_state(GlobalVariables *g1, GlobalVariables *g2,
 ...
 const vector<pair<string, char> > &resolver) {
  ...
  refMap.unmarshal(g1->GV(an_arr), g2->GV(an_arr), r[12]);
  refMap.unmarshal(g1->k_SID, g2->k_SID, r[13]);
  if (g2->run_pm_php$testinclude_php) g1->run_pm_php$testinclude_php = true;
  if (g2->run_pm_php$$home$marvin$school$hiphop$util$helper_php) g1->run_pm_php$$home$marvin$school$hiphop$util$helper_php = true;
