...
static void get_static_global_variables(Array &res) {
  ...
  static_global_variables.set("gv_an_int", g->GV(an_int));
  static_global_variables.set("gv_i", g->GV(i));
...
static void get_pseudomain_variables(Array &res) {
  ...
  pseudomain_variables.set("run_pm_php$run_php", g->run_pm_php$run_php);
