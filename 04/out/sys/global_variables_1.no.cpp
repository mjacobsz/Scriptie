  ...
  switch (hash & 31) {
    ...
    case 3:
      ...
      HASH_RETURN_NAMSTR(0x6649184C41356B03LL, s_ss41356b03, g->GV(HTTP_RAW_POST_DATA),
                         18);
      HASH_RETURN_NAMSTR(0x78E4782F5605B123LL, s_ss5605b123, g->GV(an_int),
                         6);
      break;
    case 9:
    ...
    case 25:
      ...
      break;
    case 30:
      HASH_RETURN_NAMSTR(0x066E259A1CC5B17ELL, s_ss1cc5b17e, g->GV(i),
                         1);
      break;
    case 31:
...
bool GlobalVariables::class_exists(const char *s) {
  return false;
}
